	...
	factory: (require) => {
		...
		*/
		const stateSchema = Schema.object({
			...
			experts: Schema.array(expertSchema)
		});
		/** The enabled set a writer sends. */
		const enabledSchema = Schema.array(Schema.string());
		Schema.object({ enabled: Schema.array(Schema.string()) });
		/**
		...
		*/
		function ExpertAgentsSection({ ctx, remote }) {
			return function ExpertAgentsSectionView() {
				...
				const [openSlug, setOpenSlug] = (0, react.useState)(void 0);
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
							className: "ea-muted",
							children: [`${state.enabled.length} of ${state.experts.length} enabled. `, "A model can summon an enabled expert with the summon_expert tool. The expert answers one question and stops; this session keeps the task, the judgment, and the final answer."]
						}),
								...
								return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
											...
											className: "ea-more",
											"aria-expanded": open,
											onClick: () => setOpenSlug(open ? void 0 : expert.slug),
											children: open ? "Hide detail" : "Detail"
										})]
									}), !open ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										className: "ea-detail",
										children: [
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
												className: "ea-mandate",
												children: expert.mandate
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h4", {
												className: "ea-h4",
												children: `Skills (${expert.skills.length})`
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
												className: "ea-skills",
												children: expert.skills.map((skill) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
													className: "ea-skill",
													children: [
														...
														/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
															className: "ea-skilldesc",
															children: skill.present ? ` ${skill.description}` : ` (bundle missing: ${skill.id})`
														}),
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h4", {
												className: "ea-h4",
												children: "Hands off to"
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
												className: "ea-routes",
												children: expert.routes.map((route) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
													className: "ea-route",
													children: `${route.need} → ${route.to}`
												}, route.need))
											})
										]
									})]
		...
		*/
		async function apply(ctx) {
			...
			const remote = ctx.get("remote.expertAgents");
			if (remote === void 0) throw new Error("dsh-expert-agents: remote.expertAgents did not mount");
			const Section = ExpertAgentsSection({
				ctx,
				remote
			});
